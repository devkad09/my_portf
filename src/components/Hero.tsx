const Hero = () => {
  return (
    <section className="relative min-h-[110vh] flex flex-col justify-center items-center px-6 text-center overflow-hidden">
      ...
      {/* Background Blobs */}
      <div className="absolute top-1/4 left-1/4 w-[50vw] h-[50vw] bg-accent/20 blur-[150px] rounded-full pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[40vw] h-[40vw] bg-accent-secondary/10 blur-[120px] rounded-full pointer-events-none" />
