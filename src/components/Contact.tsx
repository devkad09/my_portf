...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 md:py-32 px-4 sm:px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 xl:gap-24 items-center">
          <div className="lg:col-span-5 reveal">
            ...
            <h3 className="font-heading text-3xl sm:text-4xl lg:text-6xl font-black text-white leading-tight mb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid gap-4 md:gap-8 md:grid-cols-2">
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full glass bg-white/5 border-white/5 rounded-3xl px-4 sm:px-6 py-3 sm:py-4 text-white font-medium focus:outline-none focus:border-accent transition-all text-base sm:text-sm"
                ...
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    className="w-full glass bg-white/5 border-white/5 rounded-3xl px-4 sm:px-6 py-3 sm:py-4 text-white font-medium focus:outline-none focus:border-accent transition-all h-44 resize-none text-base sm:text-sm"
                ...
                <button
                  ...
                  className="w-full glass rounded-3xl border-white/10 bg-white/5 px-6 sm:px-8 py-4 sm:py-5 text-xs sm:text-sm font-black uppercase tracking-[0.2em] text-white transition-all duration-500 hover:bg-accent hover:text-black flex items-center justify-center gap-3 min-h-[44px]"
                >
