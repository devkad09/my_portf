      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 id="process-heading" className="section-heading">
            A reliable pipeline from <span className="text-slate-500 dark:text-slate-300">concept to cloud</span>
          </h2>
            ...
            return (
              <div
                ...
                className={`rounded-3xl p-6 sm:p-7 border transition-all duration-300 flex flex-col justify-between cursor-pointer ${
                  isSelected
                    ? "glass-card border-white/40 bg-surface shadow-2xl scale-[1.03] -translate-y-1"
                    : "glass-card border-line/60 bg-surface/60 hover:border-white/20"
                }`}
              >
                <div>
                  {/* Step Header */}
                  ...
                  <div className="mt-5 space-y-2">
                    ...
                    <p className="text-xs font-mono text-ink-muted font-semibold">
                      {stage.subtitle}
                    </p>
